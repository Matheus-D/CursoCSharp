...
using CursoCSharp.MetódosEFuncoes;
    ...
    class Program {
        static void Main(string[] args) {
            var central = new CentralDeExercicios(new Dictionary<string, Action>() {
                ...
                // Métodos e Funções
                {"Exemplos Lambda - Métodos & Funções",ExemploLambda.Executar },
                {"Lambdas Como Delegates - Métodos & Funções",LambdasDelegate.Executar },
                {"Usando Delegates - Métodos & Funções",UsandoDelegates.Executar },
                {"Delegates Como Função Anonima - Métodos & Funções",DelegatesFunAnonima.Executar },
                ...
                {"Exceção Personalizada - Exceções",ExcecoesPersonalizada.Executar },
